...
<html lang="en">
  <head>
    ...
    <title>Nasser Jewelry - Edit Account</title>
    ...
    <main>
      <aside class="side__bar" id="sideBarContainer">
        ...
        <ul class="nav__list__container">
          ...
          >
          <a href="javascript:void(0);" class="nav__links">
        ...
        <ul class="nav__list__container">
          ...
          <a href="javascript:void(0);" class="nav__links active">
            ...
            <li class="nav__list">Edit Account</li></a>
          <?php } ?>
      ...
      <div class="container">
        <div class="content">
          <div class="row">
            ...
            <div class="col-1">
              <a href="<?=site_url('members')?>" class="btn btn-default form-control btn-sm">Back</a>
            </div>
          </div>
          <br/>
          <div class="full-card">
              ...
              <div class="col-8" style="padding:10px;">
                <form method="POST" class="row-form" id="frmAccount">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" value="<?=$account['Fullname']?>" name="fullname"/>
                    </div>
                    <div class="col-12">
